...
class User(AbstractUser):
    ...
    icon = models.ImageField(upload_to=settings.UPLOAD_DIR,default='/media/static/images/avater.jpg', null=True, blank=True, verbose_name="头像",help_text='头像')
    desc = models.CharField(null=True, blank=True, default='', max_length=100, verbose_name="描述", help_text='描述')
    github = models.CharField(null=True, blank=True, default='', max_length=100, verbose_name="github",help_text='github')
    qq = models.CharField(null=True, blank=True, default='', max_length=100, verbose_name="qq",help_text='qq')
    other_link = models.CharField(null=True, blank=True, default='', max_length=100, verbose_name="其他链接",help_text='其他链接')
