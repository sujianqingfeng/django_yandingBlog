# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-04-20 21:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateField(default=datetime.datetime.now, help_text='更新时间', verbose_name='更新时间')),
                ('is_delete', models.BooleanField(default=False, help_text='是否删除', verbose_name='是否删除')),
                ('url', models.ImageField(upload_to='static/images/%Y/%m/%d', verbose_name='图片url')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateField(default=datetime.datetime.now, help_text='更新时间', verbose_name='更新时间')),
                ('is_delete', models.BooleanField(default=False, help_text='是否删除', verbose_name='是否删除')),
                ('name', models.TextField(help_text='标签名字', verbose_name='标签')),
